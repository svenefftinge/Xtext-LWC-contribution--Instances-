...
* generated by Xtext
*/
package org.xtext.lwc.instances.ui.contentassist.antlr;
...
public class InstancesParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.lwc.instances.ui.contentassist.antlr.internal.InternalInstancesParser createParser() {
		org.xtext.lwc.instances.ui.contentassist.antlr.internal.InternalInstancesParser result = new org.xtext.lwc.instances.ui.contentassist.antlr.internal.InternalInstancesParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getXIntLiteralAccess().getAlternatives(), "rule__XIntLiteral__Alternatives");
					...
					put(grammarAccess.getXIntLiteralAccess().getGroup_0(), "rule__XIntLiteral__Group_0__0");
					put(grammarAccess.getXIntLiteralAccess().getGroup_1(), "rule__XIntLiteral__Group_1__0");
					...
					put(grammarAccess.getInstanceAccess().getImportsAssignment_1(), "rule__Instance__ImportsAssignment_1");
					put(grammarAccess.getInstanceAccess().getExpressionsAssignment_2(), "rule__Instance__ExpressionsAssignment_2");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getXIntLiteralAccess().getDayAssignment_0_1(), "rule__XIntLiteral__DayAssignment_0_1");
					put(grammarAccess.getXIntLiteralAccess().getMonthAssignment_0_3(), "rule__XIntLiteral__MonthAssignment_0_3");
					put(grammarAccess.getXIntLiteralAccess().getYearAssignment_0_5(), "rule__XIntLiteral__YearAssignment_0_5");
					put(grammarAccess.getXIntLiteralAccess().getValueAssignment_1_1(), "rule__XIntLiteral__ValueAssignment_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.lwc.instances.ui.contentassist.antlr.internal.InternalInstancesParser typedParser = (org.xtext.lwc.instances.ui.contentassist.antlr.internal.InternalInstancesParser) parser;
			typedParser.entryRuleInstance();
