...
* generated by Xtext
*/
package org.xtext.lwc.instances.ui.refactoring;
 ...
 */
public class InstancesRenameStrategy extends AbstractJvmModelRenameStrategy {
	...
	public static class Provider extends DefaultRenameStrategy.Provider {
		...
		public IRenameStrategy get(EObject targetElement, IRenameElementContext renameElementContext) {
			return new InstancesRenameStrategy(targetElement, getLocationInFileProvider(), jvmModelAssociations);
		}
	}
	
	protected InstancesRenameStrategy(EObject targetElement, ILocationInFileProvider locationInFileProvider,
