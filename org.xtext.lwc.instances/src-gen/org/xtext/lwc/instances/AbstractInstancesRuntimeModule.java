...
/**
 * Manual modifications go to {org.xtext.lwc.instances.InstancesRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractInstancesRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/lwc/instances/Instances.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.lwc.instances.Instances");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.xtext.lwc.instances.services.InstancesGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.parseTreeConstructor.ParseTreeConstructorFragment
	public Class<? extends org.eclipse.xtext.parsetree.reconstr.IParseTreeConstructor> bindIParseTreeConstructor() {
		return org.xtext.lwc.instances.parseTreeConstruction.InstancesParsetreeConstructor.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.xtext.lwc.instances.parser.antlr.InstancesParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.xtext.lwc.instances.parser.antlr.InstancesAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.xtext.lwc.instances.parser.antlr.internal.InternalInstancesLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.xtext.lwc.instances.parser.antlr.internal.InternalInstancesLexer> provideInternalInstancesLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.xtext.lwc.instances.parser.antlr.internal.InternalInstancesLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.xtext.lwc.instances.parser.antlr.internal.InternalInstancesLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.xtext.lwc.instances.validation.InstancesJavaValidator> bindInstancesJavaValidator() {
		return org.xtext.lwc.instances.validation.InstancesJavaValidator.class;
	}

	// contributed by org.eclipse.xtext.generator.scoping.AbstractScopingFragment
	public Class<? extends org.eclipse.xtext.scoping.IScopeProvider> bindIScopeProvider() {
		return org.xtext.lwc.instances.scoping.InstancesScopeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.generator.IGenerator> bindIGenerator() {
		return org.xtext.lwc.instances.generator.InstancesGenerator.class;
	}

	// contributed by org.eclipse.xtext.generator.formatting.FormatterFragment
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.xtext.lwc.instances.formatting.InstancesFormatter.class;
	}
