...
* generated by Xtext
*/
package org.xtext.lwc.instances.parseTreeConstruction;
...
public class InstancesParsetreeConstructor extends AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 2: return new XIntLiteral_Alternatives(this, this, 2, inst);
			case 3: return new XVariableDeclaration_Group(this, this, 3, inst);
			case 4: return new XBlockExpression_Group(this, this, 4, inst);
			...
			case 34: return new XStringLiteral_Group(this, this, 34, inst);
			case 35: return new XTypeLiteral_Group(this, this, 35, inst);
			case 36: return new XThrowExpression_Group(this, this, 36, inst);
			case 37: return new XReturnExpression_Group(this, this, 37, inst);
...
protected class Instance_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new Instance_ExpressionsAssignment_2(lastRuleCallOrigin, this, 0, inst);
			case 1: return new Instance_ImportsAssignment_1(lastRuleCallOrigin, this, 1, inst);
			case 2: return new Instance_InstanceAction_0(lastRuleCallOrigin, this, 2, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getInstanceAccess().getInstanceAction_0().getType().getClassifier())
			return null;
...
// {Instance}
protected class Instance_InstanceAction_0 extends ActionToken  {

	public Instance_InstanceAction_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getInstanceAccess().getInstanceAction_0();
	}
...
// imports+=Import*
protected class Instance_ImportsAssignment_1 extends AssignmentToken  {
	
	public Instance_ImportsAssignment_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getInstanceAccess().getImportsAssignment_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getImportRule().getType().getClassifier())) {
				...
				element = grammarAccess.getInstanceAccess().getImportsImportParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		...
		switch(index) {
			case 0: return new Instance_ImportsAssignment_1(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new Instance_InstanceAction_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class Instance_ExpressionsAssignment_2 extends AssignmentToken  {
	
	public Instance_ExpressionsAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getInstanceAccess().getExpressionsAssignment_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getXVariableDeclarationRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getInstanceAccess().getExpressionsXVariableDeclarationParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Instance_ExpressionsAssignment_2(lastRuleCallOrigin, next, actIndex, consumed);
			case 1: return new Instance_ImportsAssignment_1(lastRuleCallOrigin, next, actIndex, consumed);
			case 2: return new Instance_InstanceAction_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// {DateLiteral} => day=INT "." month=INT "." year=INT | {xbase::XIntLiteral} value=INT
protected class XIntLiteral_Alternatives extends AlternativesToken {

	public XIntLiteral_Alternatives(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Alternatives getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getAlternatives();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_Group_0(lastRuleCallOrigin, this, 0, inst);
			case 1: return new XIntLiteral_Group_1(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getXIntLiteralAccess().getDateLiteralAction_0_0().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getXIntLiteralAccess().getXIntLiteralAction_1_0().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
protected class XIntLiteral_Group_0 extends GroupToken {
	
	public XIntLiteral_Group_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getGroup_0();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_YearAssignment_0_5(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// {DateLiteral}
protected class XIntLiteral_DateLiteralAction_0_0 extends ActionToken  {

	public XIntLiteral_DateLiteralAction_0_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getDateLiteralAction_0_0();
	}
...
// => day=INT
protected class XIntLiteral_DayAssignment_0_1 extends AssignmentToken  {
	
	public XIntLiteral_DayAssignment_0_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getDayAssignment_0_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_DateLiteralAction_0_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getXIntLiteralAccess().getDayINTTerminalRuleCall_0_1_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getXIntLiteralAccess().getDayINTTerminalRuleCall_0_1_0();
			return obj;
		}
		return null;
	}
...
// "."
protected class XIntLiteral_FullStopKeyword_0_2 extends KeywordToken  {
	
	public XIntLiteral_FullStopKeyword_0_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getFullStopKeyword_0_2();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_DayAssignment_0_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// month=INT
protected class XIntLiteral_MonthAssignment_0_3 extends AssignmentToken  {
	
	public XIntLiteral_MonthAssignment_0_3(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getMonthAssignment_0_3();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_FullStopKeyword_0_2(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override	
	public IEObjectConsumer tryConsume() {
		if((value = eObjectConsumer.getConsumable("month",true)) == null) return null;
		IEObjectConsumer obj = eObjectConsumer.cloneAndConsume("month");
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getXIntLiteralAccess().getMonthINTTerminalRuleCall_0_3_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getXIntLiteralAccess().getMonthINTTerminalRuleCall_0_3_0();
			return obj;
		}
		return null;
	}
...
// "."
protected class XIntLiteral_FullStopKeyword_0_4 extends KeywordToken  {
	
	public XIntLiteral_FullStopKeyword_0_4(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getFullStopKeyword_0_4();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_MonthAssignment_0_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// year=INT
protected class XIntLiteral_YearAssignment_0_5 extends AssignmentToken  {
	
	public XIntLiteral_YearAssignment_0_5(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getYearAssignment_0_5();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_FullStopKeyword_0_4(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getXIntLiteralAccess().getYearINTTerminalRuleCall_0_5_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getXIntLiteralAccess().getYearINTTerminalRuleCall_0_5_0();
			return obj;
		}
		return null;
	}
...
protected class XIntLiteral_Group_1 extends GroupToken {
	
	public XIntLiteral_Group_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getGroup_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_ValueAssignment_1_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getXIntLiteralAccess().getXIntLiteralAction_1_0().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// {xbase::XIntLiteral}
protected class XIntLiteral_XIntLiteralAction_1_0 extends ActionToken  {

	public XIntLiteral_XIntLiteralAction_1_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getXIntLiteralAction_1_0();
	}
...
// value=INT
protected class XIntLiteral_ValueAssignment_1_1 extends AssignmentToken  {
	
	public XIntLiteral_ValueAssignment_1_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getXIntLiteralAccess().getValueAssignment_1_1();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_XIntLiteralAction_1_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(valueSerializer.isValid(obj.getEObject(), grammarAccess.getXIntLiteralAccess().getValueINTTerminalRuleCall_1_1_0(), value, null)) {
			type = AssignmentType.TERMINAL_RULE_CALL;
			element = grammarAccess.getXIntLiteralAccess().getValueINTTerminalRuleCall_1_1_0();
			return obj;
		}
		return null;
	}
...
protected class XVariableDeclaration_TypeAssignment_1 extends AssignmentToken  {
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new XVariableDeclaration_XVariableDeclarationAction_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class XBlockExpression_Group extends GroupToken {
    ...
    @Override
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getXBlockExpressionAccess().getObjectLiteralAction_0().getType().getClassifier())
			return null;
		return eObjectConsumer;
	}
...
// {ObjectLiteral}
protected class XBlockExpression_ObjectLiteralAction_0 extends ActionToken  {

	public XBlockExpression_ObjectLiteralAction_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Action getGrammarElement() {
		return grammarAccess.getXBlockExpressionAccess().getObjectLiteralAction_0();
	}
...
protected class XBlockExpression_LeftCurlyBracketKeyword_1 extends KeywordToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XBlockExpression_ObjectLiteralAction_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class XBlockExpression_ExpressionsAssignment_2 extends AssignmentToken  {
	
	public XBlockExpression_ExpressionsAssignment_2(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getXBlockExpressionAccess().getExpressionsAssignment_2();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getXExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getXBlockExpressionAccess().getExpressionsXExpressionParserRuleCall_2_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new XBlockExpression_ExpressionsAssignment_2(lastRuleCallOrigin, next, actIndex, consumed);
...
protected class XBlockExpression_RightCurlyBracketKeyword_3 extends KeywordToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XBlockExpression_ExpressionsAssignment_2(lastRuleCallOrigin, this, 0, inst);
...
protected class XExpression_XAssignmentParserRuleCall extends RuleCallToken {
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getXIntLiteralAccess().getDateLiteralAction_0_0().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getXBlockExpressionAccess().getObjectLiteralAction_0().getType().getClassifier() && 
...
protected class XLiteral_XIntLiteralParserRuleCall_2 extends RuleCallToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new XIntLiteral_Alternatives(this, this, 0, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getXIntLiteralAccess().getDateLiteralAction_0_0().getType().getClassifier() && 
		   getEObject().eClass() != grammarAccess.getXIntLiteralAccess().getXIntLiteralAction_1_0().getType().getClassifier())
			return null;
		if(checkForRecursion(XIntLiteral_Alternatives.class, eObjectConsumer)) return null;
		return eObjectConsumer;
	}
