 ...
 * @generated
 */
public class InstancesSwitch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case InstancesPackage.DATE_LITERAL:
			{
			...
			case InstancesPackage.OBJECT_LITERAL:
			{
				ObjectLiteral objectLiteral = (ObjectLiteral)theEObject;
				T result = caseObjectLiteral(objectLiteral);
				if (result == null) result = caseJvmIdentifiableElement(objectLiteral);
				if (result == null) result = caseXBlockExpression(objectLiteral);
